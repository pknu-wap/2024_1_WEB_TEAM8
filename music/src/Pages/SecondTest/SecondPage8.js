...
const SecondPage8 = () => {
    ...
    return (
        ...
        <div className="firstPage">
            ...
            <div className="num2">
                <h3>흑인의 색감이 진하게 나타는 섹시한 보컬과 그루브. 많은 장르의 요소에 흑인의 소울을 합쳐 센스있게 조화를 이루는 음악.<br/>
오늘 너와 나를 더 끈적하게 만들어줄것 같아.</h3>
                <RbBox id="NeoRB2"/>
            </div>
            <div className="num2">
                <h3>현대의 대중적인 장르와 사운드엔 꼭 흑인의 그루브와 소울이 담겨야 한다고 생각해.
...
마치 녹아내린 초콜릿 위에서 춤을 추고 싶어져!</h3>
            ...
            <div className="num2">
                <h3>여러 장르를 혼합해 장르를 단정 지을 수 없는 아티스트만의 스타일이 담긴 음악.
